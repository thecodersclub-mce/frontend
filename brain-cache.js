...
const quizStartTime = new Date("November 15, 2025 18:00:00 GMT+0530"); // 6:00 PM IST
const quizEndTime = new Date("November 16, 2025 18:00:00 GMT+0530");  // 6:00 PM IST
...
            statusElement.innerHTML = 'BRAIN CACHE - WEEK 6 QUIZ<br>Quiz is LIVE! Ends on 16/11/2025 6:00 PM IST!';
...
            statusElement.innerHTML = 'BRAIN CACHE - WEEK 6 QUIZ<br>starts at 6.00 PM on 15/11/2025!';
            statusElement.style.color = '#FFA500'; // Orange for upcoming
        } else {
            // Quiz ended
            quizShouldBeEnabled = false;
            statusElement.innerHTML = 'BRAIN CACHE - WEEK 6 QUIZ<br>Quiz is now CLOSED.'; // Updated text for clarity
...
    else {
        quizShouldBeEnabled = false;
        statusElement.innerHTML = 'Frontend Development Series ended.'; // Indicate manual disable
