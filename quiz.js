...
            statusElement.innerHTML = 'BRAIN CACHE - WEEK 5 QUIZ<br>Quiz is LIVE! Ends on 09/11/2025 6:00 PM IST!';
...
            statusElement.innerHTML = 'BRAIN CACHE - WEEK 5 QUIZ<br>starts at 6.00 PM on 08/11/2025!';
            statusElement.style.color = '#FFA500'; // Orange for upcoming
        } else {
            // Quiz ended
            quizShouldBeEnabled = false;
            statusElement.innerHTML = 'BRAIN CACHE - WEEK 5 QUIZ<br>Quiz is now CLOSED.'; // Updated text for clarity
...
    else {
        quizShouldBeEnabled = false;
        statusElement.innerHTML = 'BRAIN CACHE - WEEK 5 QUIZ<br>Quiz is currently disabled'; // Indicate manual disable
