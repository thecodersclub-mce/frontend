...
const quizStartTime = new Date("September 28, 2025 15:00:00 GMT+0530"); // 6:00 PM IST
const quizEndTime = new Date("September 29, 2025 18:00:00 GMT+0530");  // 6:00 PM IST
...
function setLinkStatus() {
    ...
    if (timerControlStatus === "enable") {
        if (currentTime >= quizStartTime && currentTime < quizEndTime) {
            ...
            statusElement.innerHTML = 'MINDMASH - 30 QNS QUIZ<br>Stay Tuned for Updates!';
            ...
            statusElement.innerHTML = 'MINDMASH - FINAL QUIZ<br>Stay Tuned for Updates!';
